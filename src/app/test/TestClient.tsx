...
export default function TestClient({ session, config }: TestClientProps) {
            ...
            <div className="flex items-start gap-3 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
              ...
              <div className="text-sm text-blue-300">
                ...
                <p className="text-blue-400/80">
                  Minimum {config.minWpm} WPM • {config.minAccuracy}% Accuracy • Max {config.maxMistakes} Mistakes to pass and earn a certificate.
                </p>
              </div>
            </div>
